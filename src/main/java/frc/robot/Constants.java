...
public final class Constants {
  ...
  public static final class Arm {
    public static final int kArmCanId = 49;
    public static final boolean kArmInverted = true;
    public static final int kCurrentLimit = 40;

    public static final double kSoftLimitReverse = -0.9 * 5;
    ...
    public static final PIDGains kArmPositionGains = new PIDGains(15.5, 0.0, 0.0);
  ...
  public static final class Launcher {
    public static final int kTopCanId = 52;
    public static final int kBottomCanId = 53;
    ...
    public static final double kTopReversePower = 0.3;
    public static final double kBottomReversePower = 0.3;
